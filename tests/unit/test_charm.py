...
import ops.testing
from charm import DjangoCodenerixCharm
...
class TestCharm(unittest.TestCase):
    def setUp(self):
        ...
        # https://juju.is/docs/sdk/testing#heading--simulate-can-connect
        ops.testing.SIMULATE_CAN_CONNECT = True
        self.addCleanup(setattr, ops.testing, "SIMULATE_CAN_CONNECT", False)

        self.harness = Harness(DjangoCodenerixCharm)
    ...
    def test_config_changed_valid_can_connect(self):
        ...
        self.assertEqual(
            updated_env, {"GUNICORN_CMD_ARGS": "--log-level debug"}
        )
        self.assertEqual(self.harness.model.unit.status, ActiveStatus())
